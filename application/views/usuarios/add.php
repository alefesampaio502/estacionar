          ...
          <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <label>Nome</label>
                    <input type="text" name="first_name" class="form-control form-control-user" value="<?php echo set_value('first_name'); ?>" placeholder="Login">
     ...
     <button class="btn btn-primary mr-5 float-right" style="border-radius: 0;">Salvar</button>
